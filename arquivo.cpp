    ...
    QFile arq(arquivo + ".csv");
        ...
        if(arq.isOpen()){
            for(auto d : a.returnVector()){
                ...
                QString linha = d.getNome() + "," + QString::number(d.getMedia()) + "," + QString::number(d.getNota1()) + "," + QString::number(d.getNota2()) + "," + d.getRaca() + "," + QString::number(d.getIdade()) + "," + d.getSexo() + "," + d.getResponsavel() + "," + d.getAdestrador() + "," + d.getAvaliador1() + "," + d.getAvaliador2() + "\n";
